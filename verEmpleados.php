	...
	<header>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-14">
						<div class="col-md-14 order-details">
							<div class="section-title text-center">
								<h3 class="title">Empleados</h3>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="createEmpleado.php" class="btn btn-success"><i class="fa fa-pills"></i> Agregar Empleado</a>
        	...
        	$(document).ready(function(){
                ...
                $("#delete-button").click(function(){
                    ...
                    $.ajax({
                        ...
                        data: {idEmpleado:$("#idtodelete").val()},
                        beforeSend: function() {
                            $("#loading-spinner").attr('style','display: flex !important;');
                        },
                        success: function(datos) {
