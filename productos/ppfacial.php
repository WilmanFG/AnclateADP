			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="ppfacial.php">Protección Facial</a></li>
...
<?php
    ...
    $query = mysqli_query($conexion,"SELECT * FROM producto AS p INNER JOIN tipoproducto AS tp ON p.idTipoProducto= tp.idTipoProducto INNER JOIN medida AS m ON p.idMedida = m.idMedida WHERE p.idTipoProducto = '4' ");
