			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="sisIngeniera.php">Sistemas de Ingeniería</a></li>
						<li><a href="altura.php">Altura</a></li>
						<li><a href="ppmanos.php">Protección para Manos</a></li>
...
<?php
    ...
    if($conexion->connect_errno){
        ...
        $query = mysqli_query($conexion,"SELECT * FROM producto AS p INNER JOIN tipoproducto AS tp ON p.idTipoProducto= tp.idTipoProducto INNER JOIN medida AS m ON p.idMedida = m.idMedida WHERE p.idTipoProducto = '1' ");
