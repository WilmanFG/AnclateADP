        ...
        <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    if(isset($_POST["enviar"])){
                        ...
                        try{
                            ...
                            if(!empty($contra))
                            {
                                $sql = "UPDATE empleado SET dui = ?, nombres = ?, apellidos = ?, correo = ?, telefono = ?, contra = ?, direccion=?  WHERE idEmpleado = ?";
                                ...
                                $statement->bindParam(6,$contrasena_hash);                                
                            ...
                            {
                                $sql = "UPDATE empleado SET dui = ?, nombres = ?, apellidos = ?, correo = ?, telefono = ?, direccion=?  WHERE idEmpleado = ?";
                                $statement = $dbconnection->prepare($sql);
                                $statement->bindParam(1,$dui);
                                $statement->bindParam(2,$nombres);
                                $statement->bindParam(3,$apellidos);
                    ...
                    if(isset($_GET["id"])){
                        ...
                        ?>
                            <form method="POST">
                                ...
                                <button type="submit" class="btn btn-primary" name="enviar"><i class="fa fa-edit"></i> Actualizar Perfil</button>
                            </form>
                        <?php
                        }
                        else
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    ?>
                    " class="btn btn-success"><i class="fa fa-arrow-left" ></i> Regresar</a>
